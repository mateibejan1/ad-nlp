...
class Pan2011_Mail_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = pan2011_mails_dataset(directory=root, train=True, test=True)
...
def pan2011_mails_dataset(directory='../data/pan2011_mails/', train=True, test=False, clean_txt=False):
