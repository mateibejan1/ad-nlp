...
class Gutenberg_Categories_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = gutenberg_categories_dataset(directory=root, train=True, test=True)
...
def gutenberg_categories_dataset(directory='./data/gutenberg_categories/', train=True, test=False, clean_txt=False):
            ...
            for line in lines:
                if line != '\n':
                    ...
                    if data_dict_train['text'] == None:
                        data_dict_train['text'] = [line[:10000]]
                    else:
                        data_dict_train['text'].append(line[:10000]) 
            ...
            for line in lines:
                if line != '\n':
                    ...
                    if data_dict_test['text'] == None:
                        data_dict_test['text'] = [line[:10000]]
                    else:
                        data_dict_test['text'].append(line[:10000]) 
