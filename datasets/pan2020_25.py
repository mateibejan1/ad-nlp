...
class Pan2020_25_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = pan2020_25_dataset(directory=root, train=True, test=True)
...
def pan2020_25_dataset(directory='../data/pan2020_25/', train=True, test=False, clean_txt=False):
