...
class Vua_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = vua_dataset(directory=root, train=True, test=True)
...
def vua_dataset(directory='./data/vua/', train=True, test=False, clean_txt=False):
