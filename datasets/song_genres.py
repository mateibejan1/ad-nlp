...
class Song_Genres_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = song_genres_dataset(directory=root, train=True, test=True)
...
def song_genres_dataset(directory='../data/song_artists/', train=True, test=False, clean_txt=False):
