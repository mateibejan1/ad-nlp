...
class Pan2020_5_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = pan2020_5_dataset(directory=root, train=True, test=True)
        print(self.train_set, self.test_set)
        # Pre-process
...
def pan2020_5_dataset(directory='../data/pan2020_5/', train=True, test=False, clean_txt=False):
