...
class Gutenberg_Authors_Dataset(TorchnlpDataset):
    ...
    def __init__(self, root: str, normal_class=0, tokenizer='spacy', use_tfidf_weights=False, append_sos=False,
        ...
        self.train_set, self.test_set = gutenberg_authors_dataset(directory=root, train=True, test=True)
...
def gutenberg_authors_dataset(directory='./data/gutenberg_authors/', train=True, test=False, clean_txt=False):
